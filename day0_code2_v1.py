...
def read_updates_from_file(file_path):
    ...
    updates_from_file = [
        ...
        "eric-cloud-native-base.eric-log-transformer.egress.syslog.remoteHosts[0].port",  # Placeholder key
        ...
        "eric-cloud-native-base.eric-log-transformer.egress.syslog.remoteHosts[1].port",  # Placeholder key
